...
all:
	...
	ar rcs common.a common/obj/common.o
	...
	$(COMAND) -c sorter/PreciseTimer.cpp $(INC) -o sorter/obj/PreciseTimer.o
	$(COMAND) -c sorter/Sorter.cpp $(INC) -o sorter/obj/Sorter.o
	$(COMAND) sorter/obj/main.o sorter/obj/FilePool.o sorter/obj/FilePools.o sorter/obj/PreciseTimer.o sorter/obj/Sorter.o -o sorter_exe common.a
